...
; breakout for apple2
;
; copyright (c) 2023-24 kouji55@gmail.com
;
;******************************************
...
.proc draw_block
	...
	ball_pos   = z_temp + 1	 ;ボール座標(X or Y)
	block_pos  = z_temp + 2	 ;ブロック座標(X or Y)
...
; 10 -> 11 -> ブロック消去 -> 00
b_data1_cnt:
.byte $35                     ;テーブルデータの個数(個数領域も含む)
b_data1:	
.byte $80,$01,$04,$01,$08     ;１つ目のブロックデータ
.byte $80,$05,$04,$01,$08     ;２つ目のブロックデータ
.byte $80,$09,$04,$01,$08     ;３つ目のブロックデータ
